...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_2.alignment().concat(_descriptor_3.alignment().concat(_descriptor_0.alignment().concat(_descriptor_12.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_2.toValue(value_0.info).concat(_descriptor_3.toValue(value_0.dataType).concat(_descriptor_0.toValue(value_0.data).concat(_descriptor_12.toValue(value_0.domain_sep))));
  }
}
      ...
      mint: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('mint',
                                      ...
                                      'dao-shielded-token.compact line 14 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
  ...
  initialState(...args_0) {
    ...
    if (!(initNonce_0.buffer instanceof ArrayBuffer && initNonce_0.BYTES_PER_ELEMENT === 1 && initNonce_0.length === 32))
      __compactRuntime.type_error('Contract state constructor',
                                  ...
                                  'dao-shielded-token.compact line 10 char 1',
                                  'Bytes<32>',
                                  initNonce_0)
